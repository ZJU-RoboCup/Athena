...
switch = function()
	...
	elseif gCurrentState == "attackDef" then
		--print(cond.markingFrontValid(CGeoPoint:new_local(checkPosX,checkPosY),checkDir),cond.canNorPass2Def())
		if bufcnt(not cond.markingFrontValid(CGeoPoint:new_local(checkPosX,checkPosY),checkDir) or cond.canNorPass2Def(checkDir),10,gMarkFront2Def) then
