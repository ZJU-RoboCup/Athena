...
void CImmortalsVision::ProcessRobots ( WorldState * state )
{
    int robots_num = 0;
    ...
    FilterRobots ( robots_num , COLOR_BLUE );
	...
	//The most important part, The Kalman Filter!
    FilterRobots ( robots_num , COLOR_YELLOW );
...
int CImmortalsVision::ExtractBlueRobots ( void )
{
	int ans = 0;
...
int CImmortalsVision::ExtractYellowRobots ( void )
{
	int ans = 0;
	for ( int i = 0 ; i < CAM_COUNT ; i ++ )
	{
...
int CImmortalsVision::MergeRobots ( int num )
{
	int robots_num = 0;
	for ( int i = 0 ; i < num ; i ++ )
	{
...
void CImmortalsVision::FilterRobots ( int num , bool own )
{
	float filtout[2][2];
	float filtpos[2];
...
void CImmortalsVision::predictRobotsForward( WorldState * state )
{  
...
void CImmortalsVision::SendStates ( WorldState * state )
{
