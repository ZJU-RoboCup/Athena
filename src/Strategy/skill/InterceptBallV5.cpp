...
CInterceptBallV5::CInterceptBallV5()
{
...
void CInterceptBallV5::toStream(std::ostream& os)const
{
	os << " Jam and Push";
}
void CInterceptBallV5::plan(const CVisionModule* pVision)
{
...
void CInterceptBallV5::planApproachOpp(const CVisionModule* pVision, const int myID, const int oppID, const double finaldir, double subDist)
{
...
int CInterceptBallV5::checkOpp(const CVisionModule* pVision)
{
...
bool CInterceptBallV5::checkOppProccession(const CVisionModule* pVision, const int oppID)
{
...
bool CInterceptBallV5::isVisionHasBall(const CVisionModule* pVision, const int vecNumber)
{
