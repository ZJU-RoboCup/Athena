...
public:
	...
	void updateVision(int cycle, const VehicleInfoT& player, const MobileVisionT& ball, bool invert, int realNum); // 更新视觉信息
	...
	bool collideWithBall() const { return _collisionSimulator.hasCollision(); }            // 只是单纯地考虑是否相撞与碰撞区域
